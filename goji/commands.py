...
def login(base_url, email, password, is_interactive):
    ...
    if is_interactive:
        ...
        click.echo(click.style('Missing email and running in non-interactive', fg='red'))
        return

    elif password is None:
        click.echo(
            click.style('Missing password for user, {email}, and running in non-interactive'
                 .format(email=email), fg='red')
        )
        return
